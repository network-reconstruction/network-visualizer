...
Welcome to ``network-visualizer`` contributor's guide.
...
If you experience bugs or general issues with ``network-visualizer``, please have a look
...
You can help improve ``network-visualizer`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``network-visualizer`` documentation uses Sphinx_ as its main documentation compiler.
...
or Miniconda_::
    ...
    conda create -n network-visualizer python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/network-visualizer.git
...
#. Install |pre-commit|_::
   ...
   ``network-visualizer`` comes with a lot of hooks configured to automatically help the
